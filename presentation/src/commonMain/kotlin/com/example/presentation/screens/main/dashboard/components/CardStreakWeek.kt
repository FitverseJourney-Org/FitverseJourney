...
@Composable
fun CardStreakWeek(state: com.example.presentation.screens.main.dashboard.components.StreakState) {
    ...
    Card(
        ...
        _root_ide_package_.com.example.presentation.screens.main.dashboard.components.StreakWeek(
            state = state,
...
@Composable
fun StreakWeek(
    state: com.example.presentation.screens.main.dashboard.components.StreakState,
    ...
    Row(
        ...
        for(i in 0 until 7){
            ...
            _root_ide_package_.com.example.presentation.screens.main.dashboard.components.DayRing(
