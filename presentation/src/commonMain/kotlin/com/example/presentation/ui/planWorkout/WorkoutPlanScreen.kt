...
import com.example.presentation.ui.planWorkout.components.ActiveWorkoutView
import com.example.presentation.ui.planWorkout.components.RestDayView
import com.example.presentation.ui.planWorkout.components.WeekDaySelector
import com.example.presentation.ui.planWorkout.components.getMockExercises
...
fun WorkoutPlanScreen(
    ...
    val weekPlan = remember {
        listOf(
            DailyWorkoutState(DayOfWeek.MON, "Seg", WorkoutCategory("Treino A", "Peito e Tríceps",
                getMockExercises(1)
            )),
            DailyWorkoutState(DayOfWeek.TUE, "Ter", WorkoutCategory("Treino B", "Costas e Bíceps",
                getMockExercises(2)
            )),
            DailyWorkoutState(DayOfWeek.WED, "Qua", null),
            DailyWorkoutState(DayOfWeek.THU, "Qui", WorkoutCategory("Treino C", "Pernas Completas",
                getMockExercises(3)
            )),
            DailyWorkoutState(DayOfWeek.FRI, "Sex", WorkoutCategory("Treino D", "Ombros e Abdômen",
                getMockExercises(4)
            )),
